...
def parse_args():
    ...
    parser.add_argument('--geometric_weight', type=int, default=10, help='Weight for Geometric Properties')
    parser.add_argument('--dimension', type=int, default=2, help='2D for the curvature of lines and 3D for the curvature of surfaces')
...
#     check_folder(os.path.join(args.result_dir, args.dataset, 'img_new7_train'))
    check_folder(os.path.join(args.result_dir, args.dataset, '2d_canny_test'))
